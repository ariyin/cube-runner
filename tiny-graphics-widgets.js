    ...
    class Controls_Widget {
        ...
        constructor(element, scenes) {
            const rules = [".controls-widget * { font-family: monospace }",
                ...
                ".controls-widget table.control-box td .control-div { background: White; height:338px; width:1042px; padding: 5px 5px 5px 30px; }",
                ...
                ".controls-widget button:hover { transform: scale(1.1); color:#FFFFFF }",
